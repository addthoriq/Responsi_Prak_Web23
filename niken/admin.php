...
if(isset($_POST['update_product'])){
   ...
   if ($_FILES['update_p_image']['name'] != "") {
      ...
      $query = "UPDATE `products` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'";
   } else {
      $query = "UPDATE `products` SET name = '$update_p_name', price = '$update_p_price' WHERE id = '$update_p_id'";
   }
